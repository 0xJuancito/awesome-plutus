...
- [Docs](https://docs.cardano.org/projects/plutus/en/latest)
...
- [Forum](https://forum.cardano.org/c/developers/cardano-plutus)

#### Plutus Pioneer Program

- [Web](https://developers.cardano.org/en/plutus-pioneer-program/)
- [GitHub Repository](https://github.com/input-output-hk/plutus-pioneer-program)
- [Lectures](https://www.youtube.com/watch?v=IEn6jUo-0vU&list=PLK8ah7DzglhhJzuiz7X33UCHSTYPB-8Jt)
